...
CREATE TABLE IF NOT EXISTS `darq`.`business` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `owner` INT NOT NULL,
  `status` ENUM('TENTATIVE', 'LISTED', 'APPROVED', 'REJECTED', 'DELETED', 'EXPIRED') NOT NULL DEFAULT 'TENTATIVE',
  ...
  INDEX `status` USING BTREE (`status`) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `darq`.`rating` (
  ...
  `public_user_id` CHAR(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `darq`.`business_tentative_update` (
  `business_id` INT NOT NULL,
  `status` ENUM('TENTATIVE', 'LISTED', 'APPROVED', 'REJECTED', 'DELETED') NOT NULL DEFAULT 'TENTATIVE',
...
-- -----------------------------------------------------
-- Table `darq`.`business_subscription_price`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `darq`.`business_subscription_price` (
  `months` INT NOT NULL,
...
-- Table `darq`.`payment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `darq`.`payment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `date` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `amount` DOUBLE NOT NULL,
  `amount_after_deductions` DOUBLE NOT NULL,
  `description` VARCHAR(255) NOT NULL,
  `payment_provider` CHAR(16) NOT NULL,
  `id_at_payment_provider` CHAR(32) NOT NULL,
  `business_user_id` INT NULL,
  `business_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_payment_business1_idx` (`business_id` ASC) VISIBLE,
  INDEX `fk_payment_business_user1_idx` (`business_user_id` ASC) VISIBLE,
  CONSTRAINT `fk_payment_business1`
    FOREIGN KEY (`business_id`)
    REFERENCES `darq`.`business` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE,
  CONSTRAINT `fk_payment_business_user1`
    FOREIGN KEY (`business_user_id`)
    REFERENCES `darq`.`business_user` (`id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
