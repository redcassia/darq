...
import 'package:darq/views/shared/custom_card/horizontal_tile/horizontal_split_tile.dart';
import 'package:darq/views/shared/custom_card/horizontal_tile/tile_content_expanded.dart';
import 'package:darq/views/shared/custom_card/horizontal_tile/tile_content_leading.dart';
...
import 'package:darq/views/home/shared/description_widget.dart';
import 'package:darq/views/home/screens/profile_template.dart';

class ListProfileTemplate extends StatefulWidget {
  ...
  ListProfileTemplate(
      ...
      this.subtitle = true});
  @override
  _ListProfileTemplateState createState() => _ListProfileTemplateState();
}

class _ListProfileTemplateState extends State<ListProfileTemplate> {
  var rating = 0.0;
...
class GeneralProfileAppBar extends StatelessWidget {
  ...
  final ListProfileTemplate widget;
